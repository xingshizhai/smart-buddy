...
| **macOS** monitor only | `idf.py -p /dev/cu.usbmodem31401 monitor` |
...
4. The port is **COM3** on Windows. On macOS the device appears as `/dev/cu.usbmodem31401`.
...
- **Serial port**: COM3 (Windows) / `/dev/cu.usbmodem31401` (macOS)
